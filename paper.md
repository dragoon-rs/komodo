...
The library is implemented in the _Rust_ programming language and available under the MIT license on the ISAE-SUPAERO GitLab instance[^1] with a mirror on GitHub[^2].
